...
//query
$query = "SELECT * FROM `back` where id = $id";
...
if (isset($_POST['update'])) {
    ...
    $query = "UPDATE `back` SET `Id`='$id',`First Name`='  $f_name ',`Father Name`='$fa_name',`Email Address`='$email',`Nic`='$nic ',`Contact No`='$cno',`Designation`=' $designation',`Salary`='$salary ',`Experience`='$exp' Where id=$id";
