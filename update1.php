...
if (isset($_POST['update'])) {
    ...
    $query = "UPDATE `data` SET `Id`='$id',`First Name`='  $f_name ',`Father Name`='$fa_name',`Email Address`='$email',`Nic`='$nic ',`Contact No`='$cno',`Designation`=' $designation',`Salary`='$salary ',`Experience`='$exp' Where id=$id";
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5">
                    ...
                    <!-- show data button -->
                    <a href="display1.php" class="btn btn-warning px-4 mt-5">Employee Data</a>
                </div>
                <div class="col"></div>
