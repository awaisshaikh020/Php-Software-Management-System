...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO `full`( `First Name`, `Father Name`, `Email Address`, `Nic`, `Contact No`, `Designation`, `Salary`, `Experience`) VALUES (' $f_name','$fa_name','$email ',' $nic','$cno ','$designation','$salary','$exp')";
    ...
    if ($result) {
        ...
        window.location.href = 'display3.php'; 
        </script>";
    } else {
