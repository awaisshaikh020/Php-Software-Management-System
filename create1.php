...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO `data`( `First Name`, `Father Name`, `Email Address`, `Nic`, `Contact No`, `Designation`, `Salary`, `Experience`) VALUES (' $f_name','$fa_name','$email ',' $nic','$cno ','$designation','$salary','$exp')";
