        ...
        <div class="container">
            ...
            <div class="row mb-4 g-4 text-center justify-content-center">
                <div class="col-auto">
                    ...
                    <!-- main-heading -->
                    <span class="heading">
                        <h1>FULL STACK EMPLOYEE DATA 2023</h1>
                    </span>
                </div>
                ...
                <div class="col-md-2">
                    ...
                    <!-- Add button -->
                    <a href="create3.php" class="btn btn-warning ">Add Employee</a>
                </div>
            </div>
            ...
            <div class="row justify-content-center mb-5">
                <div class="col-md-6">
                    ...
                    <form class="d-flex">
                        ...
                        <!-- rest-button -->
                        <a href="display3.php" class="btn btn-outline-danger">Reset</a>
                    </form>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <table class="table table text-center table-hover table-bordered table-striped">
                    <thead>
                        <tr class=" bg-dark text-white bg-dark text-white">
                            <th scope="col">#ID</th>
                    ...
                    <tbody id="myTable">
                        ...
                        $query = "SELECT * FROM `full` ORDER BY `First Name` ASC";
                        ...
                        if ($result) {
                            ...
                            <td>' . $salary      . '</td>
                            <td>' . $exp         . '</td>
                            <td><a href="update3.php? updateid= ' . $id . '" class = "text-light btn btn-primary">Update</a></td>
                            <td><a href="delete3.php? deleteid= ' . $id . '" class = "text-light btn btn-danger">Delete</a></td>
                            </tr>';
                            }
                        }
